...
export class ShippingService {
  ...
  async addTrackingEvent(data: {
    ...
    // Map ShipmentStatus to TrackingEventType
    const statusMap: Record<ShipmentStatus, any> = {
      [ShipmentStatus.PENDING]: 'created',
      [ShipmentStatus.PICKED]: 'picked_up',
      [ShipmentStatus.PACKED]: 'picked_up',
      [ShipmentStatus.LABELED]: 'picked_up',
      [ShipmentStatus.HANDOVER]: 'in_transit',
      ...
      [ShipmentStatus.CANCELLED]: 'exception',
    };
    
    const event = this.trackingEventRepository.create({
      shipmentId: data.shipmentId,
      type: statusMap[data.status] || 'exception',
